...
export const SHOCKS: ShockDefinition[] = [
  ...
  },
  {
    ...
    tagline: "Crypto companies get hit first. Jumpy growth and money-app names often follow.",
    driver: "Crypto",
    headlinePct: -0.35,
    mechanism: "Bitcoin falls hard. Companies that hold crypto, mine it, or trade it get hit first. Jumpy money-app and growth names often follow.",
    tacticalAction: "Check borrowed money. Crypto-linked names can swing a lot.",
  },
  {
    id: "broad_down15",
    label: "Broad −15%",
  ...
  },
  {
    ...
    label: "Risk rally +12%",
    shortLabel: "Rally +12%",
    tagline: "Good news. Jumpy growth, money apps, space, and crypto usually lead.",
