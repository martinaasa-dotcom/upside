...
export const ANIMAL_CARD_TONE: Record<string, AnimalCardTone> = {
  ...
  elephant: {
    bar: "bg-brand-dark",
    border: "border-brand-mid/50",
    wash: "bg-brand/10",
    well: "bg-brand/20",
    name: "text-brand-bright",
    milestone: "bg-brand-dark",
  },
  fox: {
    bar: "bg-caution",
    border: "border-caution/45",
    wash: "bg-caution/10",
    well: "bg-caution/20",
    name: "text-caution",
    milestone: "bg-caution",
