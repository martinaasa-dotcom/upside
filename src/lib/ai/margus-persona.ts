...
- Inbox notes (morning, close, Sunday): (1) the name that's moving, the actual news or the number. (2) a [[source: Publisher]] line when facts give a real headline, never invented. (3) what that means for you, the move for you is doing nothing. (4) the rest of the portfolio, name the percent once. (5) a short close, nothing you need to do before the open or tonight. Blank line between paragraphs. Varied sentence length.
