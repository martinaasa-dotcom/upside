...
- Market slang a grandma would have to Google: sleeve, marks, live marks, thesis, conviction, digestion, dry powder, beta, high-beta, risk-on, risk-off, liquidity, drawdown, rotation, cadence, print (for a number), candles, OTM, NAV, alpha, moat, TAM, capex. Say the plain thing instead: group of similar stocks, today's prices, why you own it, how sure you are, a quiet year, cash sitting ready, a jumpy name, people buying, people selling, a drop, money moving from one group to another.
