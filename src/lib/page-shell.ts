...
export const PAGE_FRAME_CLASS =
  "page-frame flex min-h-dvh flex-col bg-app bg-[radial-gradient(ellipse_at_top,_#161b25_0%,_#08090c_55%)] text-foreground [--dock-pad:10.5rem] md:[--dock-pad:11.5rem]";
