...
export const PAGE_FRAME_CLASS =
  "page-frame flex min-h-dvh flex-col bg-app text-foreground [--dock-pad:10.5rem] md:bg-[radial-gradient(ellipse_at_top,_#161b25_0%,_#08090c_55%)] md:[--dock-pad:11.5rem]";
...
export const PAGE_MAIN_CLASS = `${PAGE_COLUMN_CLASS} flex flex-1 flex-col gap-5 pt-6 pb-[var(--dock-pad)] sm:gap-6 sm:pt-8`;
