...
export const serverEnvSchema = z.object({
  ...
  X_API_KEY: z.string().trim().min(8).optional(),
  X_API_SECRET: z.string().trim().min(8).optional(),
  X_ACCESS_TOKEN: z.string().trim().min(8).optional(),
  X_ACCESS_TOKEN_SECRET: z.string().trim().min(8).optional(),
