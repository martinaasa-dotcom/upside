  ...
  return (
    ...
    >
      ...
      {showSilentCard && (
        <div
          role="status"
          className="pointer-events-auto w-[min(22rem,calc(100vw-1.5rem))] cursor-pointer overflow-hidden rounded-xl glass ring-1 ring-foreground/10"
      ...
      {open && (
        <section
          ref={panelRef}
          className={`pointer-events-auto flex flex-col overflow-hidden rounded-xl glass ring-1 ring-foreground/10 transition-[width,height] duration-200 ease-out ${
            wide
                ...
                <div
                  ...
                  className={
                    message.role === "user"
                      ...
                      : "w-full min-w-0 rounded-xl glass ring-1 ring-foreground/10 px-4 py-3 text-base text-foreground"
                  }
                >
                  <p
                    className={
