    ...
    <SignInGate>
      ...
      {settingsOpen && (
        <ViewportOverlay className="z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
          ...
          />
          <div className="relative max-h-full w-full max-w-sm overflow-y-auto rounded-t-xl bg-popover ring-1 ring-foreground/10 p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] sm:rounded-xl sm:pb-6">
            <div className="mb-4 flex items-start justify-between gap-3">
      ...
      {bestiaryOpen && (
        <ViewportOverlay className="z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
          ...
          />
          <div className="relative max-h-full w-full overflow-y-auto rounded-t-xl bg-popover ring-1 ring-foreground/10 p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] sm:max-w-lg sm:rounded-xl sm:pb-6">
