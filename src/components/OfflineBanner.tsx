...
export function OfflineBanner() {
  ...
  return (
    ...
    >
      <span className="inline-flex items-center gap-1.5 rounded-full border border-caution/40 bg-background/90 px-2.5 py-1 text-xs font-medium text-caution shadow-lg backdrop-blur">
