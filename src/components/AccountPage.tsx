...
function VisitStreakCard() {
  ...
  return (
    <section className="flex flex-col gap-3 rounded-xl glass ring-1 ring-foreground/18 p-6">
    ...
    <SignInGate>
      <div className={PAGE_FRAME_CLASS}>
        ...
        <main id="main" className={PAGE_MAIN_CLASS}>
          ...
          <section className="flex flex-col gap-4 rounded-xl glass ring-1 ring-foreground/18 p-6">
            <div className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-border bg-accent text-foreground">
