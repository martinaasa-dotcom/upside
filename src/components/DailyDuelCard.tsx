...
export function DailyDuelCard({
  ...
  if (!pair) {
    return (
      <section
        className={cn(
          "card-sheen glass min-h-[13.5rem] rounded-xl p-6 ring-1 ring-foreground/18"
        )}
      >
          ...
          return (
            <button
              ...
              className={cn(
                ...
                myPick == null
                  ? "border-border bg-muted hover:scale-[1.02] hover:border-ring/40 hover:bg-accent active:scale-[0.98]"
                  : win
