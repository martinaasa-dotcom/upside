...
export function ListingCurrencyChip({
  ...
  return (
    <span
      ...
      className={cn(
        "inline-flex h-5 shrink-0 items-center rounded-md border border-border bg-muted/50 px-1.5 text-xs font-semibold leading-none tracking-wide text-muted-foreground",
        className
      )}
    >
      {unit}
