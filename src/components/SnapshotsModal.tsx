  ...
  return (
    <ViewportOverlay className="z-[60] flex items-center justify-center p-4">
      <button
        ...
        onClick={onClose}
      />
      <div className="relative z-10 flex max-h-[min(100%,560px)] w-full max-w-md flex-col overflow-hidden rounded-xl bg-popover ring-1 ring-foreground/18 shadow-sm">
