  ...
  return (
    <div className="inline-flex items-center justify-center gap-0.5">
      <input
        ...
        className="inline-edit no-spinner w-10 rounded py-0.5 text-center tabular-nums text-zinc-100 outline-none hover:bg-zinc-800/50 focus:bg-zinc-900 focus:ring-1 focus:ring-brand/40"
      />
  ...
  return (
    <div className="inline-flex items-center justify-center gap-0.5">
      ...
      <input
        ...
        className="inline-edit no-spinner w-16 rounded py-0.5 text-center tabular-nums text-zinc-100 outline-none hover:bg-zinc-800/50 focus:bg-zinc-900 focus:ring-1 focus:ring-brand/40"
      />
    </div>
  );
}
